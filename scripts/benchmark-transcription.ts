 ...
 *   --models <list>     Comma-separated list of models to test (default: gemini-flash-latest,gemini-3-pro-preview)
 */
...
async function runBenchmark(
  ...
  const models = modelList || ['gemini-flash-latest', 'gemini-3-pro-preview'];
...
if (!audioFile) {
  ...
  console.log('  --models <list>     Comma-separated list of models (default: gemini-flash-latest,gemini-3-pro-preview)');
  process.exit(1);
}
